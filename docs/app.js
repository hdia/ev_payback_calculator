    ...
    <div class="notes-row">
      <div class="card">
        ...
        <div class="note" style="margin-top:12px">
           ...
           Figures are indicative for informational purposes only, and depend heavily on charging access and energy prices.
        </div>
                    
        <div class="footer footer-center">
          Research tool developed by Swinburne University of Technology to support evidence-based EV cost comparisons. 
        </div>    
      </div>
    </div>
  `;
